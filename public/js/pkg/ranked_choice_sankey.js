...
* @param {any} js_config
*/
export function start(canvas_id, js_config) {
    var ptr0 = isLikeNone(canvas_id) ? 0 : passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    wasm.start(ptr0, len0, addHeapObject(js_config));
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('ranked_choice_sankey_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
